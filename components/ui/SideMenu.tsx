    ...
    >
        <Box sx={{ width: 250, paddingTop: 5 }}>
            ...
            <List>
...

                {
                    isLoggedIn && (
                        <>
                            <ListItem 
                                button
                                onClick={() => navigateTo ( '/profiles/profile' ) }
                            >
                                <ListItemIcon>
                ...
                onClick={ () => navigateTo('/category/Flor_de_temporada') }
                >
                    <ListItemIcon>
                        <MaleOutlined/>
                    </ListItemIcon>
                    <ListItemText primary={'Flor de temporada'} />
                </ListItem>

                <ListItem 
                button 
                sx={{ display: { xs: '', sm: 'none' } }}
                onClick={ () => navigateTo('/category/Fruta_de_temporada') }
                >
                    <ListItemIcon>
                        <FemaleOutlined/>
                    </ListItemIcon>
                    <ListItemText primary={'Fruta de temporada'} />
                </ListItem>

                <ListItem 
                button 
                sx={{ display: { xs: '', sm: 'none' } }}
                onClick={ () => navigateTo('/category/Vegetales') }
                >
                    <ListItemIcon>
